package org.geektimes.projects.user.repository.jpa;

import org.geektimes.projects.user.sql.DbSqlInit;
...
public class DelegatingEntityManager implements EntityManager  {
    ...
    private Map loadProperties(String propertiesLocation) {
        ...
        // 增加 JNDI 引用处理
        ComponentContext componentContext = ComponentContext.getComponentContext();
